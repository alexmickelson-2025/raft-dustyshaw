...
public class PauseTests
{
    ...
    public void PausingLeadersInElectionLoops()
    {
        ...
        // assert
        followerNode.Received(0).RecieveAppendEntriesRPC(Arg.Any<int>(), Arg.Any<Guid>(), Arg.Any<int>(), Arg.Any<List<Entry>>(), Arg.Any<int>(), Arg.Any<AppendEntriesRPC>());
    }
    ...
    public void LeadersCanUnPause()
    {
        ...
        // assert
        followerNode.Received(1).RecieveAppendEntriesRPC(Arg.Any<int>(), Arg.Any<Guid>(), Arg.Any<int>(), Arg.Any<List<Entry>>(), Arg.Any<int>(), Arg.Any<AppendEntriesRPC>());
